...
extern int __init tx51_init_mc13892(void);
extern void __init tx51_io_init(void);
...
struct cpu_wp *tx51_get_cpu_wp(int *wp)
{
	*wp = num_cpu_wp;
	return cpu_wp_auto;
}

void tx51_set_num_cpu_wp(int num)
{
	num_cpu_wp = num;
	return;
}
				   ...
				   char **cmdline, struct meminfo *mi)
{
	...
	get_cpu_wp = tx51_get_cpu_wp;
	set_num_cpu_wp = tx51_set_num_cpu_wp;
}
